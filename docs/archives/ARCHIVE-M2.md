# M2 Archive — clinlat substrate kernel (`clinlat-v0.3.0`)

**Status:** Archived 2026-07-22 — M2 complete, shipped 2026-07-10.
**Scope:** Detailed task tables for completed M2 phases, moved out of Plans.md to keep the active plan focused on M3. See Plans.md for stub pointers and the M2 Definition of Done.
